...
export class ShoppingCart {
    ...
    //parses through stringify cart, creates shopping cart object
    static parse(cartString){
        if(!cartString) return null;
        const obj = JSON.parse(cartString);
        // json file to shopping cart obj
        const sc = new ShoppingCart(obj.uid) // new shopping cart object with uid
        sc.items = obj.items // passes obj's items to new shopping cart object
        return sc;
    }
